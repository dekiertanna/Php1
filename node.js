   ...
   function start()
   {
      ...
      document.getElementById( "parentButton" ).addEventListener(
         "click", parent, false );
      document.getElementById("showChilds").addEventListener(
          "click",childs,false);
   ...
   function insert()
   {
      ...
      if (divtresc.hasChildNodes())
      divtresc.insertBefore( newNode, divtresc.firstElementChild );
      else
      divtresc.appendChild(newNode);
      switchTo( newNode );
   } // end function insert
   ...
   function remove()
   {
      if ( currentNode== document.getElementById("tresc") )
         alert( "Can't remove a divtresc." );
      else
      {
   ...
   function parent()
   {
      if (currentNode==divtresc)
         alert("No acces to divtresc parent");
      else
      {
  ...
  function childs()
  {
     ...
     var fchild=divtresc.firstElementChild;
     fchild.setAttribute("class","red");
     var third=fchild.nextElementSibling.nextElementSibling;
     third.setAttribute("class","red");
     var last=divtresc.lastElementChild;
     last.setAttribute("class","red");
     window.alert("Liczba dzieci"+divtresc.childElementCount);
