		...
		<meta charset="UTF-8">
         ...
         [bigheading] Modele samochodów</h1>
                  ...
                  id = "replaceButton">
																					...
																					<p>
																						<input type = "button" value = "Usuń bieżący"
                  id = "removeButton">
																						</p>
																						<p>
																							<input type = "button" value = "Pobierz rodzica"
                  id = "parentButton">
																							</p>
																							<p>
																								<input type = "button" value = "Podswietl dzieci divtresc"
                       id = "showChilds">
																								</p>
																							</form>
																							...
																							<form  action="#" onsubmit = "return sprawdzFormularz (this)" onreset = "return czyZresetowac(this)">
																								<label>
																									<input type="text" name="imie" autofocus>Imię</label>
																									<br>
