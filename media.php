         ...
         <div id="tlo">
               <div id="container" class="bordered">
                    ...
                    <h1>Animacje</h1>
                        ...
                        <div class="flex-item"><table style="width:100%">
                            <tr>
                                <td>
                                    <img src="ferrari.jpg" alt="Ferrari Logo" style="max-width:100%;max-height:100%;">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Ferrari</h3>
                                    <hr>
                                    Enzo Ferrari od 1929 roku prowadził stajnię wyścigową o nazwie Scuderia Ferrari i osiągał znaczne sukcesy w wyścigach samochodowych.

1947 - model Ferrari 125 S z silnikiem 1,5 litra V12 (12 cylindrów).
...
W 2002 roku, kiedy sytuacja przedsiębiorstwa nie miała się najlepiej, Fiat (główny udziałowiec Ferrari) sprzedał 34% akcji bankowi Mediobanza za 768 mln USD. We wrześniu 2006 roku Fiat odkupił 29% akcji i obecnie posiada 85% udziałów. 10% należy do syna Enzo Ferrariego, a pozostałe 5% w 2005 roku odkupił Mubadala Development od banku Mediobanza.
                        ...
                        <div class="flex-item"><table style="width:100%">
                            <tr>
                                <td>
                                    <img src="lamborghini.png" alt="Lamborghini Logo" style="max-width:100%;max-height:100%;">
                                </td>
                            </tr>
                            <tr>
                                <td>
...
W 1982 roku Lamborghini przedstawiło prototyp surowego samochodu terenowego oznaczony jako LM001. W 1986 roku, po dokonaniu szeregu modyfikacji, wszedł do produkcji seryjnej jako LM002. Dzięki swojemu wyglądowi do dziś pozostaje jednym z najbardziej oryginalnych samochodów terenowych wszech czasów. Następcą modelu Countach w 1990 roku zostało Diablo i produkowany był przez ponad dziesięć lat. Z kolei jego następca, model Murciélago, pojawił się dopiero w 2001 roku. Małe modele Lamborghini były produkowane z dużymi przerwami. Po modelu Urraco trzeba było czekać trzy lata na kolejny "mały" model, Jalpa, który produkowano do 1989 roku. W 1995 przedstawiono prototyp Cala z silnikiem V10 3.9 L . o mocy 400 KM. Do seryjnej produkcji jednak nie doszło. Dopiero model Gallardo w 2003 roku godnie zastąpił poprzednie modele. Ciekawostką jest to, że marka Lamborghini oznacza oprócz supersamochodów przede wszystkim ciągniki rolnicze i po Fiacie jest drugim co do wielkości ich producentem we Włoszech.
                        ...
                        <div class="flex-item"><table style="width:100%">
                            <tr>
                                <td>
                                    <img src="porsche.png" alt="Porsche Logo" style="max-width:100%;max-height:100%;">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <h3>Porsche</h3>
                                    <hr>
                                    25 kwietnia 1931 roku Ferdinand Porsche założył firmę początkowo konstruującą samochody, a następnie z nakazu Adolfa Hitlera pojazdy wojskowe i pancerne dla III Rzeszy Niemieckiej w czasie II wojny światowej konkurując z firmą Henschel.

Logo firmy Porsche, w kształcie herbu, które pozostało niezmienione do czasów współczesnych, w centralnej części ma umieszczonego biegnącego konia, który został zapożyczony z herbu miasta Stuttgart, w którym mieści się przedsiębiorstwo[2].
